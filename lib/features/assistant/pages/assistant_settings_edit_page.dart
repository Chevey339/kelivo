                ...
                children: [
                  Expanded(
                    ...
                    tabs: [
                      ...
                      l10n.assistantEditPageToolsTab,
      ...
      body: GestureDetector(
        ...
        child: TabBarView(
          ...
          children: [
            ...
            _ToolsTab(assistantId: assistant.id),
...
class _ToolsTab extends StatelessWidget {
  const _ToolsTab({required this.assistantId});
  final String assistantId;
            ...
            child: Column(
              children: [
                _iosSwitchRow(
                  ...
                  value: a.enableWebSearch,
                  onChanged: (v) async {
                    await context.read<AssistantProvider>().updateAssistant(a.copyWith(enableWebSearch: v));
                  },
                ),
              ],
            ),
