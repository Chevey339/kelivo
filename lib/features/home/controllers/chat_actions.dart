...
class ChatActions {
  ...
  List<ChatMessage> get _allMessagesForApi {
    final conversationId = _currentConversation?.id;
    if (conversationId == null) return _messages;
    return chatController.chatService.getMessages(conversationId);
  }
