...
import 'message_tree_utils.dart';
...
class MessageBuilderService {
  ...
  ///
  /// Delegates to [MessageTreeUtils] for shared tree/flat collapse logic.
  List<ChatMessage> collapseVersions(
    List<ChatMessage> items,
    Map<String, int> versionSelections,
  ) {
    return MessageTreeUtils.collapseVersions(items, versionSelections);
  }
