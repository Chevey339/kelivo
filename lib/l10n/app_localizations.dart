...
abstract class AppLocalizations {
  ...
  /// No description provided for @faqEntry1GeneralTipsTitle.
  ///
  /// In en, this message translates to:
  /// **'Tips for new Kelivo users'**
  String get faqEntry1GeneralTipsTitle;

  /// No description provided for @faqEntry1GeneralTipsSummary.
  ///
  /// In en, this message translates to:
  /// **'1. Regular backups are strongly recommended (local or remote), as Hive database files may become corrupted after a crash.\n2. Do not delete assistants casually — all chat history under that assistant will be permanently lost.\n3. For long conversations, avoid the built-in Sample Assistant and the assistant memory feature, as they inject dynamic variables into system prompts which hurt cache hit rates.\n4. If you are not familiar with Temperature and Top_P, leave them unset and use the provider\'s defaults (for most providers, the defaults are sufficient).\n5. To ensure cache effectiveness, disable the message count limit in assistant settings.\n6. Split unrelated conversations into separate chat windows so the model can focus better and you reduce token costs.'**
  String get faqEntry1GeneralTipsSummary;

  /// No description provided for @faqEntry1BillingPrivacyTitle.
  ///
  /// In en, this message translates to:
  /// **'Does Kelivo charge fees or collect my data?'**
  String get faqEntry1BillingPrivacyTitle;

  /// No description provided for @faqEntry1BillingPrivacySummary.
  ///
  /// In en, this message translates to:
  /// **'Kelivo is free and open-source. It has no backend server — your data flows only to the AI provider that processes your requests. In practice, as with all third-party clients, you will most likely need to top up credits to use paid AI services (unless you use locally deployed models or free models from certain providers).'**
  String get faqEntry1BillingPrivacySummary;

  /// No description provided for @faqEntry1AgentSkillsTitle.
  ///
  /// In en, this message translates to:
  /// **'Does Kelivo support Skills, Agents, or a local sandbox?'**
  String get faqEntry1AgentSkillsTitle;

  /// No description provided for @faqEntry1AgentSkillsSummary.
  ///
  /// In en, this message translates to:
  /// **'As a lightweight client, Kelivo focuses on polished chat and tool calling (including MCP). Skills support may be added in the future. Full Agent functionality and a local sandbox are beyond the intended scope of this project and are unlikely to be implemented.'**
  String get faqEntry1AgentSkillsSummary;

  /// No description provided for @faqEntry1ApiCallsTitle.
  ///
  /// In en, this message translates to:
  /// **'Does one conversation only make a single API call?'**
  String get faqEntry1ApiCallsTitle;

  /// No description provided for @faqEntry1ApiCallsSummary.
  ///
  /// In en, this message translates to:
  /// **'No, there are several scenarios that trigger additional calls:\n1. Title generation runs automatically — set it to a cheap model and disable thinking for it in Default Model settings.\n2. Chat suggestions are off by default; if enabled, each suggestion triggers a separate request.\n3. History summarization is off by default; if enabled, it generates requests automatically.\n4. OCR fallback — if you send an image to a non-vision model with an OCR model configured, one OCR request is made.\n5. Tool calls require context round-trips, producing multiple calls per conversation — this is expected behavior.\n6. Kelivo does not make any background API requests without user action.'**
  String get faqEntry1ApiCallsSummary;

  /// No description provided for @faqEntry1FeedbackTitle.
  ///
  /// In en, this message translates to:
  /// **'Where can I ask questions or provide feedback?'**
  String get faqEntry1FeedbackTitle;

  /// No description provided for @faqEntry1FeedbackSummary.
  ///
  /// In en, this message translates to:
  /// **'Go to the Following/Discover page in the app to find community links. You can join the community to ask questions, or report issues on GitHub.'**
  String get faqEntry1FeedbackSummary;

  /// No description provided for @faqSectionErrors.
  ///
  /// In en, this message translates to:
  /// **'Troubleshooting'**
  String get faqSectionErrors;

  /// No description provided for @faqEntry2Http404Title.
  ///
  /// In en, this message translates to:
  /// **'HTTP 404 error when sending messages'**
  String get faqEntry2Http404Title;

  /// No description provided for @faqEntry2Http404Summary.
  ///
  /// In en, this message translates to:
  /// **'Please check:\n1. Whether your provider supports the Response API — as of June 2026, only OpenAI and a few others support it; DeepSeek does not.\n2. Whether you have accidentally modified the API path — if it does not show the default black /chat/completions, restore it. Gray text means the field has been cleared and needs to be re-entered.'**
  String get faqEntry2Http404Summary;

  /// No description provided for @faqEntry2BalanceTitle.
  ///
  /// In en, this message translates to:
  /// **'Insufficient balance'**
  String get faqEntry2BalanceTitle;

  /// No description provided for @faqEntry2BalanceSummary.
  ///
  /// In en, this message translates to:
  /// **'Your API provider returned an insufficient balance error. Please top up at the provider\'s official platform.'**
  String get faqEntry2BalanceSummary;

  /// No description provided for @faqEntry2GeminiTitle.
  ///
  /// In en, this message translates to:
  /// **'Using Gemini models through third-party providers'**
  String get faqEntry2GeminiTitle;

  /// No description provided for @faqEntry2GeminiSummary.
  ///
  /// In en, this message translates to:
  /// **'When accessing Gemini models through a third-party API endpoint (not Google\'s official API), keep the provider type set to OpenAI in provider settings — the type only indicates API compatibility, not actual model selection. Third-party endpoints almost certainly only support the OpenAI-compatible format; changing the type to Gemini or manually adding /v1beta to the path will not help and may cause additional issues.'**
  String get faqEntry2GeminiSummary;

  /// No description provided for @faqEntry2NoVisionTitle.
  ///
  /// In en, this message translates to:
  /// **'Model cannot process images or returns image_url / no endpoint errors'**
  String get faqEntry2NoVisionTitle;

  /// No description provided for @faqEntry2NoVisionSummary.
  ///
  /// In en, this message translates to:
  /// **'First, verify from an authoritative source whether your model actually supports vision input. If it does, go to Model settings and manually declare vision capability. If it does not (e.g., DeepSeek V4 Flash/Pro supports vision on the website but not via API), configure an external OCR model in Default Model settings.'**
  String get faqEntry2NoVisionSummary;

  /// No description provided for @faqSectionSearch.
  ///
  /// In en, this message translates to:
  /// **'Search'**
  String get faqSectionSearch;

  /// No description provided for @faqEntry3SearchQualityTitle.
  ///
  /// In en, this message translates to:
  /// **'Search quality is poor'**
  String get faqEntry3SearchQualityTitle;

  /// No description provided for @faqEntry3SearchQualitySummary.
  ///
  /// In en, this message translates to:
  /// **'The built-in Bing search has limited quality. For better results, try the Tavily API or the Exa MCP service (which currently offers a free tier).\n\nAs of June 2026. Service availability and pricing may change. Community recommendation, not an official Kelivo endorsement.'**
  String get faqEntry3SearchQualitySummary;

  /// No description provided for @faqEntry3ContextExplosionTitle.
  ///
  /// In en, this message translates to:
  /// **'Context length explodes after fetching web pages'**
  String get faqEntry3ContextExplosionTitle;

  /// No description provided for @faqEntry3ContextExplosionSummary.
  ///
  /// In en, this message translates to:
  /// **'If you do not have specific requirements, disable the fetch_html method in the built-in fetch tool settings to avoid injecting large amounts of raw HTML into the context.'**
  String get faqEntry3ContextExplosionSummary;

  /// No description provided for @faqSectionCache.
  ///
  /// In en, this message translates to:
  /// **'Cache'**
  String get faqSectionCache;

  /// No description provided for @faqEntry4CacheHitrateTitle.
  ///
  /// In en, this message translates to:
  /// **'Abnormally low cache hit rate'**
  String get faqEntry4CacheHitrateTitle;

  /// No description provided for @faqEntry4CacheHitrateSummary.
  ///
  /// In en, this message translates to:
  /// **'To improve cache performance:\n1. Disable assistant memory in Assistant settings.\n2. Remove frequently changing variables like cur_time from system prompts.\n3. Avoid using the built-in Sample Assistant, as it contains dynamic variables.\n4. Disable the message count limit — its query needs vary by conversation.'**
  String get faqEntry4CacheHitrateSummary;

  /// No description provided for @faqEntry4ClaudeCacheTitle.
  ///
  /// In en, this message translates to:
  /// **'Claude prompt caching is not being triggered'**
  String get faqEntry4ClaudeCacheTitle;

  /// No description provided for @faqEntry4ClaudeCacheSummary.
  ///
  /// In en, this message translates to:
  /// **'Go to provider settings and enable Claude Prompt Caching. You can set the cache TTL to 5 minutes or 1 hour depending on your usage pattern.'**
  String get faqEntry4ClaudeCacheSummary;

  /// No description provided for @faqSectionBackup.
  ///
  /// In en, this message translates to:
  /// **'Backup & Sync'**
  String get faqSectionBackup;

  /// No description provided for @faqEntry5BackupRestoreTitle.
  ///
  /// In en, this message translates to:
  /// **'How to backup and restore data'**
  String get faqEntry5BackupRestoreTitle;

  /// No description provided for @faqEntry5BackupRestoreSummary.
  ///
  /// In en, this message translates to:
  /// **'Local backup: simply export a backup file from the Backup settings page. To restore, import the file and choose Smart Merge to avoid losing recent changes.'**
  String get faqEntry5BackupRestoreSummary;

  /// No description provided for @faqEntry5CrossDeviceSyncTitle.
  ///
  /// In en, this message translates to:
  /// **'How to sync data between two devices'**
  String get faqEntry5CrossDeviceSyncTitle;

  /// No description provided for @faqEntry5CrossDeviceSyncSummary.
  ///
  /// In en, this message translates to:
  /// **'Use WebDAV or S3 storage (recommend Nutstore or Cloudflare R2). Upload from one device, then on the other device restore using Smart Merge (not Full Overwrite) to preserve both sides\' data.\n\nAs of June 2026. Service availability may change. Community recommendation, not an official Kelivo endorsement.'**
