...
class AppLocalizationsZhHant extends AppLocalizationsZh {
  ...
  @override
  String get assistantEditProactiveCarePromptDefault =>
      '現在到了你主動給使用者發訊息的時間。請保持你的角色設定，結合上下文與當前時間，主動給使用者發一條自然、貼心的訊息。只輸出訊息內容本身。';
  ...
  @override
  String get assistantEditProactiveCareExactAlarmPermissionDenied =>
      '未授予精確鬧鐘權限，主動關懷無法準時喚醒應用程式，請在系統設定中允許「鬧鐘與提醒」。';
