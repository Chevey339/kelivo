...
class TombstoneRows extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  TombstoneRows(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> scope = GeneratedColumn<String>(
    'scope',
    aliasedName,
    false,
  ...
  @override
  TombstoneRows createAlias(String alias) {
    return TombstoneRows(attachedDatabase, alias);
  }

  @override
  List<String> get customConstraints => const ['PRIMARY KEY(scope, entity_id)'];
  @override
  bool get dontWriteConstraints => true;
}

class ExtensionEntityRows extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  ExtensionEntityRows(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> kind = GeneratedColumn<String>(
    'kind',
    aliasedName,
    false,
  ...
  @override
  ExtensionEntityRows createAlias(String alias) {
    return ExtensionEntityRows(attachedDatabase, alias);
  }
