...
| Phase 0：止血与基线 | 5 / 9 | `进行中` | P0-01/P0-02/P0-03/P0-04/P0-08 已完成；流式持久化与 loading 止血闭环；跨平台/raw durability 继续由 OPS/发布门禁追踪 |
