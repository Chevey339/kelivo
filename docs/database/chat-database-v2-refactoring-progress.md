...
Phase 3 已完成 6/7。下一步按方案进入 `GEN-07`：补齐 chunk/onDone/cancel/切会话/kill 的竞态与迟到事件矩阵，并用 P0-09 harness 验证 100 token/s、1 MiB 长响应的 UI/DB/profile 证据。D4 renderer/RSS 超标留在 Phase 4。
