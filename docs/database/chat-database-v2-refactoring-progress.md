...
Phase 3 已完成 7/7 并通过最终全量回归。下一步按方案进入 Phase 4 `TL-01`：以 active ancestry cursor 加载逻辑 slot，退出 OFFSET/物理 revision 分页；P0-09 已确认的 D4 renderer/RSS 超标继续在 TL-05～08 处理。
