...
> - 最后更新：2026-07-12（**LIN-01 完成：发送/生成/编辑/重生成/删除与 fork 已回归纯线性写路径**）
...
| Phase 6：线性回归 v3（PD-15） | 2 / 8 | `进行中` | LIN-02/01 已完成：线性 collapse 读窗口与纯线性写事务均已扶正，GenerationRun/ordered parts/附件/搜索已改接 `message_rows`；下一项 LIN-06 |
