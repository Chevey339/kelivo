...
> 状态：全部三批已实施 —— 第一批（B1/B2/B3/B4、A1/A2/A3、A5、屏障自死锁）、第三批 C1/C2/C3（含 B5，legacy 双表与 migration 表族删除、parts 单源持久化）、A6/A9（随阶段 3）、第二批 A4/A7/A8/B6（随阶段 4：follow-up 错误上抛、updateMessage 局部列更新、三 store 写队列、启动门自愈）均已落地，经全量测试（1444 个）与对抗评审；18 条确认问题全部处理完毕
