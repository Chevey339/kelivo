...
3. **多 AI 横向对比** — 选择 2 个及以上的模型同时回答，在同一界面中横向对比回复，择优采用。
...
8. **模型能力支持** — 适配 GPT-5.6（sol/luna/terra），最高支持 xhigh/max 推理档位；同时拓展了 Qwen 3.5–3.7、Doubao seed-2 等模型家族的能力探测，确保功能可用性更准确。
